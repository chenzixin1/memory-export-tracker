...
- 2026 年 6 月全月：半导体出口 448.2 亿美元、同比 +199.5%；韩国总出口 1,022.5 亿美元、同比 +70.9%；进口 661.0 亿美元、同比 +30.1%；贸易顺差 361.5 亿美元。来源为 MOTIE 2026-07-01 发布的《2026년 6월 및 상반기 수출입 동향》，KDI 已转载。
- 2026 年 6 月 1-20 日：半导体出口 255 亿美元、同比 +188.4%；韩国总出口 620 亿美元、同比 +60.4%；进口 445 亿美元、同比 +23.2%；贸易顺差 175 亿美元。来源为 KCS 2026-06-22 旬度暂定值经 KDI 转载的官方简报。
...
- 2026 年 5 月全月：半导体出口 371.6 亿美元、同比 +169.4%；韩国总出口 877.5 亿美元、同比 +53.2%。数值首先来自 MOTIE/KCS 2026-06-01 月度口径公开报道，后由 KCS 主站于 2026-06-15 挂出的《2026년 5월 월간 수출입 현황 [확정치]》公告列表交叉确认。5 月 21-31 日尾段值 152.09 亿美元由全月半导体出口减去 5 月 1-20 日累计值反推。
...
其中部分 1-20 日数据直接来自简报正文；部分 1-10/1-20 和 5 月尾段数据由简报/月度口径披露的总量关系推算，并在 `data/trade-data.json` 的 `source` 字段标为 `official_public_derived`。截至 2026-07-10，本地环境未配置 `DATA_GO_KR_SERVICE_KEY`，但已通过浏览器/脚本核验 KCS TradeData 官方公开页并落库 2025.01-2026.05 的 SSD HS `852351` 与 DRAM/HBM HS `854232` 月度出口金额、净重和推算单位价值；2026.06 的半导体月度总量已由 MOTIE/KCS 公布，但 KCS TradeData 对 SSD / DRAM-HBM 的 2026.06 HS 月度查询仍为空。KDI 已转载 2026-06-22 的 6 月前 20 日官方旬度公告；公开官方源仍未提供 DRAM/SSD/HBM 的 2026 年 6 月 1-20 日细分拆分。
